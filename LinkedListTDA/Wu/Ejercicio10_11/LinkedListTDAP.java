...
import LinkedListTDA.Clase.Nodo;
import LinkedListTDA.Clase.list.IteratorTDA;
import LinkedListTDA.Clase.list.ListTDA;

public class LinkedListTDAP<E> implements ListTDA<E> {
  public static final int NO_ENCONTRADO = -1;
  public Nodo<E> head; // private Node<E> head -> por defecto
  private Nodo<E> cola;
  private int count;

  public LinkedListTDAP() {
    clear();
  }
  ...
  public void imprimir() {
    ...
    while (it.hasNext())
      System.out.println(((Persona) it.next()).getName());
  }
  // public void imprimir() {
  // IteratorTDA<E> it = new Iterador<E>(head);
  // while (it.hasNext())
